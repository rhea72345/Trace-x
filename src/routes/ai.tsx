      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_300px]">
        <section className="panel-surface flex h-[600px] flex-col overflow-hidden rounded-lg">
          <div className="border-b border-border px-4 py-3">
            <SectionTitle title="Investigation chat" hint="Answers are generated by the deterministic detection engine, not a live model — every claim links back to real evidence." />
          </div>
